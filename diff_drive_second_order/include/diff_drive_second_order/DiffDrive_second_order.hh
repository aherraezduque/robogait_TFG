 ...
 *
 */
#ifndef GZ_GAZEBO_SYSTEMS_DIFFDRIVE_SECOND_ORDER_HH_
#define GZ_GAZEBO_SYSTEMS_DIFFDRIVE_SECOND_ORDER_HH_
...
namespace ignition
{
  namespace gazebo
  {
    ...
    inline namespace IGNITION_GAZEBO_VERSION_NAMESPACE {
      ...
      {
        // Forward declaration
        class DiffDrive_second_order_Private;
        ...
        ///
        /// `<enable_second_order_filter>`: Enable the second order dynamics filter.
        /// Default is false.
        /// 
        ...
        {
          /// \brief Constructor
        public: DiffDrive_second_order();

              /// \brief Destructor
        public: ~DiffDrive_second_order() override = default;
        ...
        private: std::unique_ptr<DiffDrive_second_order_Private> dataPtr;
        };
      }
    }
  }
...
#endif  //GZ_GAZEBO_SYSTEMS_DIFFDRIVE_SECOND_ORDER_HH_
