...
def generate_launch_description():
    ...
    cmd=[
        'ros2', 'bag', 'record',
        #'-o', 'narx_experimentos',  # nombre del bag (carpeta)
        '/cmd_vel',
        '/cmd_vel_filtered',
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value='mi_mundo_2.sdf',
        description='World file to use in Gazebo')
    
    # Añadido NAV2
    declare_map_file_cmd = DeclareLaunchArgument(
    'map_file_name',
    default_value='/home/alvaro/robogait_TFG/src/roverrobotics_driver/maps/mi_mapa_2',
    ...
    actor_with_delay = TimerAction(period=35.0, actions=[actor_waypoints_pub_node])
