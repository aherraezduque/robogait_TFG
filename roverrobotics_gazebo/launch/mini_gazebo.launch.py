...
def generate_launch_description():
    ...
    human_distance_yolo_node = Node(
        ...
        output="screen",
        parameters=[{
            "rgb_topic": "/world/mi_mundo/model/rover_mini/link/soporte_camaras/sensor/rgbd_camera/image",
            "depth_topic": "/world/mi_mundo/model/rover_mini/link/soporte_camaras/sensor/rgbd_camera/depth_image",
